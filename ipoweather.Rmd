...
Data is imported from an excel file containing visitation various weather data points from Gothic, obtained from billy barr's website. 
...
dmat$Total <- as.numeric(dmat$Total)
dmat$Apr.1 <- as.numeric(dmat$Apr.1)
dmat$May.1 <- as.numeric(dmat$May.1)
dmat$Water <- as.numeric(dmat$Water)
dmat$Above.freezing <- as.numeric(dmat$Above.freezing)
dmat$Days.covered <- as.numeric(dmat$Days.covered)
dmat$Drought <- as.numeric(dmat$Drought)
