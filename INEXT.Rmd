...
colnames(both) <- c("1997", "1998", "2001", "2012", "2018")
...
```{r}
d1 <- iNEXT(both, q=c(0), datatype="abundance", endpoint=NULL)
d2 <- iNEXT(both, q=c(1), datatype="abundance", endpoint=NULL)
...
g1 <- ggiNEXT(d1, type=1) + 
  ...
  scale_fill_manual(values=c("mediumturquoise", "mediumturquoise", "mediumturquoise", "indianred1", "indianred1")) +
  theme_bw()
