...
g1 <- ggiNEXT(d1, type=1, grey=T) + 
  ...
  xlim(0,350) +
  ylim(0, 7.5) +
  scale_colour_manual(values=c("grey1", "grey1", "grey1", "grey", "grey")) +
  scale_fill_manual(values=c("grey45", "grey45", "grey45", "grey60", "grey60")) +
  scale_shape_manual(values=c(15, 16, 17, 19, 18)) +
  labs(x = "number of individual visits", title = "Richness", y = "visitor category diversity") +
...
order1 <- ggiNEXT(i1, type=1, grey=T) + 
  ...
  ylim(0, 7.5) +
  theme_classic() +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5), axis.title =    element_text(size=16), axis.text=element_text(size=14)) +
  scale_colour_manual(values=c("grey1","grey")) +
  scale_fill_manual(values=c("grey45","grey60")) +
  labs(x = "number of individual visits", y = "visitor category diversity") 
  # labs(title = "Richness")

order2 <- ggiNEXT(i2, type=1, grey=T) + 
  xlim(0,300) +
  ylim(0, 7.5) + 
  theme_classic() +
  theme(plot.title = element_text(hjust = 0.5, size= 14), legend.position = "top", legend.title=element_blank(),legend.text = element_text(size=8), axis.text=element_text(size=14))  +
   scale_colour_manual(values=c("grey1","grey")) +
  scale_fill_manual(values=c("grey45","grey60")) +
  labs(x = "number of individual vists", y = "visitor category diversity") 
  # labs(title = "Shannon")
...
#graph together
grid.arrange(g1, g2, order1, order2, ncol = 2)
```
